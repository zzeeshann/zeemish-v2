...
- **P1.3, P1.4, P1.5 — pending.** Producer-side learning writes (P1.3), Drafter self-reflection post-publish (P1.4), Zita-question learning (P1.5) are scheduled next. Until P1.3 lands, the learnings feed the Drafter reads is mostly StructureEditor's existing writes — a narrow loop, but a real one.
