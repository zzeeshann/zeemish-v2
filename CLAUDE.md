...
- **P1.4, P1.5 — pending.** Drafter self-reflection post-publish (P1.4) is next, to be batched into the same push as P1.3-behaviour. Zita-question learning (P1.5) waits on readers + Zita traffic.
